\subsection{Objekt H25a}
\label{subsec:ObjektH25a}
...
\par Bei \gls{H25a} handelt es sich um eine \gls{dhh}-Hälfte samt zugehöriger Garage in der Hopfengasse 25a, 92334 Berching-Sollngriesbach. Es handelt sich um ein im Jahr 1994 errichtetes \gls{dhh}, das laufend modernisiert und instand gehalten wurde. 
Das Zweifamilienhaus verfügt über 2 Wohneinheiten (25a und 25b) von denen sich die 25a im Eigentum der \gls{stz} befindet. Die vermietbare Fläche liegt bei $200 m^2$. Es besteht entsprechend §1030 BGB ein Nießbrauchrecht der vorherigen Eigentümer.
...
\midrule
Adresse & Hopfengasse 25a, 92334 Sollngriesbach \\
Objektart & Doppelhaushälfte \\
Baujahr / Modernisierung & 1994 / laufend \\
Vermietbare Fläche & $200 m^2$ Wohnen \\
Einheiten & 1 Wohneinheit \\
Vermietungsstand & 100\% per \today \\
Eigentümer & \gls{stz} \\
\bottomrule
\end{tabular*}
\caption{Objektsteckbrief H25a}
\label{tab:objektsteckbriefH25a}
\end{table}
